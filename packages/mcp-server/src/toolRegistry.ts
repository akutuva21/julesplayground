...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Validate first for normal workflows; do not use for parameter sweeps (parameter_scan) or event/phase summaries (temporal_analysis).',
