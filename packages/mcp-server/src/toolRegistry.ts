...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Use when calculating dynamic time-course trajectories; do not use for event or phase summaries (use temporal_analysis) or a finite parameter grid (use parameter_scan).',
