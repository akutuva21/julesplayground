...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Validate first for normal workflows; use for trajectory output; do not use for event/phase summaries (use temporal_analysis) or parameter sweeps (use parameter_scan).',
