...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Use for forward time-series trajectories or observable timecourses from a single parameter set; do not use for parameter sweeps (parameter_scan) or time-domain event summaries (temporal_analysis).',
