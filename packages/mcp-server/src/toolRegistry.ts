...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Validate first for normal workflows; use when raw time-series trajectories or observables are needed; do not use for parameter sweeps (parameter_scan) or event/phase summaries (temporal_analysis).',
