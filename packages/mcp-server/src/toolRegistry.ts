...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Use when raw time-series trajectories are needed; do not use for event/phase summaries (use temporal_analysis) or finite parameter sweeps (use parameter_scan).',
