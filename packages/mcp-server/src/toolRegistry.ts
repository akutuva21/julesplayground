...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Validate first for normal workflows; do not use for event/phase summaries (use temporal_analysis) or a finite parameter grid (use parameter_scan).',
