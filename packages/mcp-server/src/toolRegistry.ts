...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Validate first for normal workflows; use when raw trajectories or time courses are needed, and do not use for event/phase summaries (temporal_analysis) or parameter grids (parameter_scan).',
