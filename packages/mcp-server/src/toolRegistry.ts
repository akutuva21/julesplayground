...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Use when simulating single time-series trajectories; do not use for parameter sweeps (use parameter_scan) or event/phase summaries (use temporal_analysis).',
