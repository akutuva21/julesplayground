...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Use when time-course trajectories or observables are needed. Validate first for normal workflows; do not use for event/phase summaries (use temporal_analysis) or a finite parameter grid (use parameter_scan).',
