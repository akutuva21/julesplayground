...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Use for baseline time-course dynamics; do not use for parameter sweeps (parameter_scan), event/phase summaries (temporal_analysis), or model validation alone (validate_model).',
