...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Use for running an ODE, SSA, or NFsim simulation to generate trajectories or observables. Do not use for event summaries (temporal_analysis) or parameter grids (parameter_scan).',
