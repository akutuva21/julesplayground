...
export const toolDefinitions: BngToolDefinition[] = [
  ...
  define({
    ...
    description: 'Run an ODE, SSA, or NFsim simulation and return trajectories or observables. Use for forward timecourse dynamics; do not use for parameter sweeps (use parameter_scan), steady-state dose-response curves (use dose_response), or event timing summaries (use temporal_analysis).',
