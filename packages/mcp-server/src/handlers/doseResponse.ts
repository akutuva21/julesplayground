 ...
 *
 * The engine function handles parameter validation, observable resolution,
 * simulation method execution, rootfind-to-simulate fallbacks, Hill fitting,
 * and bifurcation detection directly.
 */
