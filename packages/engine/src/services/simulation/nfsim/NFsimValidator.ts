...
/**
 * Retrieves the singleton instance of the NFsimValidator.
 * Lazily instantiates the validator upon the first request.
 *
 * @returns {NFsimValidator} The global NFsimValidator singleton instance.
 * @invariant This function operates entirely within a Node.js or JS runtime and does not rely on browser-specific APIs.
 */
...
/**
 * Resets the cached singleton instance of the NFsimValidator.
 * Primarily used for testing purposes to clear previous validation state.
 *
 * @returns {void}
 * @invariant This function operates entirely within a Node.js or JS runtime and does not rely on browser-specific APIs.
 */
